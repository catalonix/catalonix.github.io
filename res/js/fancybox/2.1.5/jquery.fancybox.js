...
(function (window, document, $, undefined) {
	...
	var H = $("html"),
		...
		var ieUserAgent = {
			    ...
			    init: function () {
			        ...
			        this.docVersion = document.documentMode && document.documentMode;
		...
		ieUserAgent.init();
		var isIframePreLoad = (ieUserAgent.ie && ieUserAgent.compatibilityMode) ? false : true;
	...
	F.helpers.overlay = {
		defaults : {
			...
			locked     : false, 	//!isTouch,  // if true, the content will be locked into overlay
